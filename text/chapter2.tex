...
In \myref{fig}{fig:LLVMSyntax}, their reduced syntax of LLVM IR is given, with some small additions.\begin{figure}[!htb]
\begin{align*}
\begin{aligned}
...
\text{Binops } \mathit{bop} ::= &\mathit{ add\ |\ sub\ |\ mul\ |\ udiv\ |\ sdiv\ |\ urem\ |\ srem\ |\ shl\ |\ lshr\ |\ ashr}\\
&\mathit{|\ and\ |\ or\ |\ xor} \\
...
\text{Constants } \mathit{cnst} ::= &\mathit{t} \\
