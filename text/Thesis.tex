...
\newcommand{\MiniML}{\emph{\mbox{MiniML} }} %The stylish representation of MiniML
\newcommand{\cmath}[1]{$\mathit{#1}$} %correct Math text
\newcommand{\lsttext}[1]{\lstinline{#1}} %inline text as in listings
...
\begin{figure}[htb]
    ...
    \centering
        \begin{tabular}{|l c r|}
        \hline
        2 & \gray $loc_{frame}$ & \gray $index_{type}$\\
        \hline
        \end{tabular}
...
\hline
\end{tabular}
\caption{The representation of type definitions\label{fig:TypeDefinitionsRepresentation}}
\end{figure}

The representation of type definitions is shown in \myref{fig}{fig:TypeDefinitionsRepresentation}.
...
This is done by reusing the earlier concept of \emph{masking}\todo{REF M. Patrignani}, and applying it to closures.
