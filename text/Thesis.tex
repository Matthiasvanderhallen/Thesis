...
\begin{figure}[htb]
    ...
    \centering
        ...
        \hline
        \end{tabular}
        \caption{Type int.\label{fig:IntRepresentation}}
    \end{subfigure}
    \begin{subfigure}[b]{0.20\textwidth}
    \centering
        \begin{tabular}{|l r|}
        ...
        \hline
        \end{tabular}
        \caption{Typevar 'a. \label{fig:TypeVarRepresentation}}
    \end{subfigure}
    \begin{subfigure}[b]{0.20\textwidth}
    \centering
        \begin{tabular}{|l r|}
        ...
        \hline
        \end{tabular}
        \caption{$\mathit{ArgStruct.t_{i}}$\label{fig:ArgTypeRepresentation}}
    \end{subfigure}
    \begin{subfigure}[b]{0.20\textwidth}
    \centering
        \begin{tabular}{|l c r|}
        \hline
        3 & $loc_{frame}$ & $index_{type}$\\
        \hline
        \end{tabular}
        \caption{$\mathit{Struct.t_{i}}$\label{fig:StructTypeRepresentation}}
    \end{subfigure}
    \caption{This figure shows the representation of all different types \label{fig:TypeRepresentations}}
\end{figure}

The representation of type definitions is shown in \myref{fig}{fig:TypeDefinitionsRepresentation}.\todo{Create the figure. Normally this should suffice: name, tyvars, implementation, opaque bit}
