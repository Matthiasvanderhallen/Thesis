...
When creating a meta-frame, any type used in the typing of values is substituted by its implementation until the first opaque type is encountered.
...
When creating a meta-frame, any type used in the typing of values is substituted by its implementation until it contains only opaque types, counting \lsttext{int} as an opaque type.
...
\end{enumerate}
\end{description}
\subsection{Calling Structure Fields}
