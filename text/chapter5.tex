...
Some formal techniques of proving full abstraction exist, the ideas of one of these proof techniques are described in \myref{sec}{sec:prooftechniques}.
\myref{sec}{sec:informalproof} aims to give a short and informal proof for the compilation scheme presented earlier.
...
Trace semantics\cite{Rathke} describe the behavior of a component as a series of method calls and returns.

Full abstraction proofs based on trace semantics first show that the operational semantics of the target-language are equivalent to the proposed trace semantics.
...
The secure compilation ensures this by limiting all communication between context and 
