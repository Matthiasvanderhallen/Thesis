...
signature DICTIONARYSIGNATURE = sig
   ...
   val insert: dictionary-> string -> string
end
\end{lstlisting}
...
This method of abstraction can be used to create for example generic data structures. An example of a functor is shown in \myref{lst}{code:functor}.

\begin{lstlisting}[frame=single,numbers=left, language=ML, caption=The generic closure-evaluation entry point.,
label=code:functor]
\end{lstlisting}
